document.addEventListener('DOMContentLoaded', function() {
    ...
    // Elementos principais - CORRIGIDOS COM OS IDs REAIS DO HTML
    ...
    const resumoDiv = document.getElementById('resumo-pedido'); // ID CORRETO
    const resumoContent = document.getElementById('resumo-content'); // CONTEÚDO DO RESUMO
    const btnWhatsApp = document.getElementById('btn-whatsapp'); // ID CORRETO
    ...
    function atualizarResumo() {
        console.log('Atualizando resumo:', pedidoAtual);
